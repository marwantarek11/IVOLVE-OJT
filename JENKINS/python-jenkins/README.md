# Welcome to the Python-App Deployment on OpenShift using Jenkins Pipeline. For details, please visit the [application repository](https://github.com/marwantarek11/Lab-2.git).
